...
public class Assets {
    ...
    public static void init(){
        ...
        arrange = new BufferedImage[2];
        start = new BufferedImage[2];
        nextTurn = new BufferedImage[2];
        ...
        SpriteSheet Tokens =
                new SpriteSheet(ImageLoader.loadImage("/PlayersTokens.png"));
        ...
        arrange[0] = buttons.cut(304, 254, 394, 127);
        arrange[1] = buttons.cut(698, 254, 394, 127);
        start[0] = buttons.cut(1092, 254, 226, 110);
        start[1] = buttons.cut(1318, 254, 226, 110);
        nextTurn[0] = buttons.cut(0, 381, 444, 107);
        nextTurn[1] = buttons.cut(444, 381, 444, 107);
        ...
        tokens[0] = Tokens.cut(0, 0, 35, 35);
        tokens[1] = Tokens.cut(35, 0, 35, 35);
        tokens[2] = Tokens.cut(70, 0, 35, 35);
        tokens[3] = Tokens.cut(70, 35, 35, 35);
        tokens[4] = Tokens.cut(35, 35, 35, 35);
        tokens[5] = Tokens.cut(0, 35, 35, 35);
    }
}
